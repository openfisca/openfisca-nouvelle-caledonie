...
class pension_imposable_apres_deduction_et_abattement(Variable):
    ...
    def formula(foyer_fiscal, period, parameters):
        ...
        pension_non_rectifiee = foyer_fiscal.members("pension_retraite_rente_imposables", period)
        pension_rectifiee = foyer_fiscal.members("pension_retraite_rente_imposables_rectifiees", period)
        ...
        deduction_10_totale_individu = min_(
            pension_totale_individu * deduction_pension.taux,
        ...
        deduction_10_non_rectifiee_individu = min_(
            pension_non_rectifiee * deduction_pension.taux,
            deduction_pension.plafond
        )
        ...
        pension_apres_abattement_individu = max_(
            pension_totale_individu - deduction_10_totale_individu - abattement_individu, 0
        )
